...
import orch from "../assets/orch.avif";

const Orchestration = () => {
  return (
    <>
      <div className="h-max w-full mt-10 px-4 py-4">
        <div className="flex flex-col gap-y-4 sm:flex-row justify-between sm:px-28">
          <div className="sm:w-[60%] sm:self-center sm:flex sm:flex-col sm:gap-y-3 sm:pr-28">
          ...
          <div className="sm:w-[40%]">
            <img src={orch} alt="person_with_tea_cup" className="rounded-lg" />
          </div>
        </div>
        ...
        <div className=" 4-column h-[50%] mt-10 flex flex-col items-center gap-y-4 sm:flex-row sm:gap-x-3 sm:px-28 sm:mt-28 sm:items-start">
          <div className="w-[60%] flex flex-col gap-y-2">
            ...
            <p>
              Use Account Update to security make batch and real-time updates
          ...
          <div className="w-[60%] flex flex-col gap-y-2">
            ...
            <p>
              Route transactions to global acquirers and networks that will
              yield the fastest, most reliable and least expansive transaction.
            </p>
          </div>
        </div>
      </div>
