...
const Testimonials = () => {
  return (
    <div className="h-max w-full bg-darkBlue text-white flex flex-col gap-y-8 px-4 py-8 sm:h-[70vh] sm:flex-row sm:px-32 sm:gap-x-14">
      ...
      <div className="w-full sm:h-full sm:relative">
        <img
          ...
          className="object-cover sm:absolute sm:h-full sm:transform sm:-translate-y-16 sm:left-8"
        />
      </div>
    </div>
  );
